...
def load_data():
    ...
    feature_full=[]
    label_full=[]
    file_path =r'C:\Users\Administrator\Desktop\毕业设计\程序\cnn/kddcup.data_10_percent_corrected_handled2.cvs'
    with (open(file_path,'r')) as data_from:
        ...
        for i in csv_reader:
            ...
            # print label
            # print feature
    file_path_full =r'C:\Users\Administrator\Desktop\毕业设计\程序\cnn/kddcup.data.corrected_handled2.cvs'
